...
- Access tokens live at most 30 days; the one-year demo token of heka-auth-service has no equivalent (phase 6 replaces it with a short-lived token broker).
